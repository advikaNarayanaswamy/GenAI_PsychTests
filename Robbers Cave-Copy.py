...
user_msg3 = "Now pretend that you are a student in Group A and your team was asked to wait for food. Would you want to talk with students from Group B and make friends with them even when you know that the counsellors have been unfair to your group? Answer with only yes or no."
